defmodule BtrzHealthcheckerTest do
  ...
  setup do
    %{
      build_number: "d3b3f9133f68b8877347e06b3d7285dd1d5d3921",
      git_hash: "3d7285dd1d5d3921d3b3f9133f68b8877347e06b",
  ...
  test "returns the Info struct with the service status", env_data do
    BtrzHealthchecker.EnvironmentInfoMock
    |> stub(:build_number, fn -> env_data[:build_number] end)
    |> stub(:git_revision_hash, fn -> env_data[:git_hash] end)
    |> stub(:ec2_instance_id, fn -> env_data[:instance_id] end)
  ...
  test "returns the Info struct with the list of services status", env_data do
    BtrzHealthchecker.EnvironmentInfoMock
    |> stub(:build_number, fn -> env_data[:build_number] end)
    |> stub(:git_revision_hash, fn -> env_data[:git_hash] end)
    |> stub(:ec2_instance_id, fn -> env_data[:instance_id] end)
